...
This package provides **BYDFi exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BYDFI** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bydfi |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bydfi/issues |
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bydfi/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BYDFi exchange plugin for bt_api**。它提供了与 **BYDFI** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bydfi |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bydfi/issues) 反馈问题
